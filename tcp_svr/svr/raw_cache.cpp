...
CRawCache::CRawCache() : _data(NULL), _len(0){}
CRawCache::~CRawCache(){if (_data) delete[] _data;}

char* CRawCache::head(){return _data;}
char* CRawCache::tail(){return NULL;}
unsigned CRawCache::cached_len(){return _len;}
unsigned CRawCache::free_len(){return 0;}
